        ...
        return (
            <header className={`header-two sticky-header ${stickyheader}`}>
                        ...
                        <div className="row align-items-center">
                            <div className="col-md-6 col-sm-7">
                                <ul className="contact-list">
                                    <li><Link to="#">info@yourwebsite.com</Link></li>
                        ...
                        <div className="d-flex align-items-center justify-content-between">
                            ...
                            <div className="main-right">
                                <div className="quote-icon">
                                    <img src={process.env.PUBLIC_URL + "/assets/img/clock-icon.png"} className="icon" alt="clock " />
                                    <span>
                                        Medical Form
              <span>988. 876 76 76 8</span>
                            ...
                            <div className={classNames("hamburgerbtn", { "active": this.state.navmethod })} onClick={this.toggleNav}>
                ...
                {/* Mobile Menu */}
                <div className={classNames("mobile-menu", { "open": this.state.navmethod })}>
